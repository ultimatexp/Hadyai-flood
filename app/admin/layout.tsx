        ...
        <div className="min-h-screen bg-gray-100 flex flex-col">
            ...
            <div className="md:hidden bg-white border-b border-gray-200 overflow-x-auto">
                <div className="flex px-4 py-2 gap-2">
                    ...
                    <Link
                        href="/admin/moderation"
                        className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors flex items-center gap-2 whitespace-nowrap"
                    >
                        Moderation
                    </Link>
                    <Link
                        href="/admin/settings"
                        className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors flex items-center gap-2 whitespace-nowrap"
                    >
                        Settings
                    </Link>
                </div>
